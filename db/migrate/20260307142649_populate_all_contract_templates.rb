class PopulateAllContractTemplates < ActiveRecord::Migration[8.1]
  def up
    # Rename existing "Contrato de Compraventa" to distinguish from the new auto one
    execute <<~SQL
      UPDATE contract_templates
      SET name = 'Contrato de Compraventa de Inmueble'
      WHERE name = 'Contrato de Compraventa'
    SQL
    ...
    templates = [
      ...
      },
      {
        ...
        category: "Automotor",
        description: "Contrato de compraventa de vehículo automotor para uso en Paraguay.",
        body: <<~BODY,
      ...
      {
        name: "Contrato de Préstamo entre Personas",
        category: "Financiero",
        description: "Contrato de préstamo de dinero entre personas físicas para uso en Paraguay.",
        body: <<~BODY,
      ...
      {
        name: "Contrato de Trabajo Informal",
        category: "Laboral",
        description: "Contrato de trabajo para relaciones laborales informales en Paraguay.",
        body: <<~BODY,
          CONTRATO DE TRABAJO
      ...
      },
      {
        ...
        category: "Servicios",
        description: "Contrato de prestación de servicios profesionales para uso en Paraguay.",
        body: <<~BODY,
  ...
  def down
    ContractTemplate.where(name: [
      "Contrato de Compraventa de Autovehículo",
      "Contrato de Préstamo entre Personas",
      "Contrato de Trabajo Informal",
      "Contrato de Prestación de Servicios"
    ]).destroy_all

    execute <<~SQL
      UPDATE contract_templates
      SET name = 'Contrato de Compraventa'
      WHERE name = 'Contrato de Compraventa de Inmueble'
    SQL

    execute <<~SQL
      UPDATE contract_templates SET field_config = '{}' WHERE field_config IS NOT NULL
    SQL
  end
end
